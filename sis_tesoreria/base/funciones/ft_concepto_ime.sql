...
BEGIN
    ...
    v_nombre_funcion = 'tesor.ft_concepto_ime';
	...
	***********************************/
	...
	if(p_transaccion='TSR_CON_INS')then
        ...
        begin
			...
			v_resp = pxp.f_agrega_clave(v_resp,'mensaje','Concepto almacenado(a) con exito (id_concepto'||v_id_concepto||')'); 
            v_resp = pxp.f_agrega_clave(v_resp,'id_concepto',v_id_concepto::varchar);
	...
	***********************************/
		...
		begin
            ...
            v_resp = pxp.f_agrega_clave(v_resp,'id_concepto',v_parametros.id_concepto::varchar);
